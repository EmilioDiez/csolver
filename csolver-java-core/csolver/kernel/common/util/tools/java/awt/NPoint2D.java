...
package csolver.kernel.common.util.tools.java.awt;
 ...
 * @since 1.2
 */
public abstract class NPoint2D implements Cloneable {
     ...
     * @since 1.2
     */
    public static class Float extends NPoint2D implements Serializable {
        /**
     ...
     * @since 1.2
     */
    public static class Double extends NPoint2D implements Serializable {
        /**
         * The X coordinate of this <code>Point2D</code>.
         * @since 1.2
         * @serial
     ...
     * @since 1.2
     */
    public void setLocation(NPoint2D p) {
     ...
     * @since 1.2
     */
    public double distanceSq(NPoint2D pt) {
     ...
     * @since 1.2
     */
    public double distance(NPoint2D pt) {
        double px = pt.getX() - this.getX();
        double py = pt.getY() - this.getY();
        return Math.sqrt(px * px + py * py);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof NPoint2D) {
            NPoint2D p2d = (NPoint2D) obj;
