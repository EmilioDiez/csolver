 ...
 * @since       1.0
 */
public class NPoint extends NPoint2D implements java.io.Serializable {
    /**
     ...
     * @see         java.util.NPoint#setLocation(java.util.NPoint)
     * @see         java.util.NPoint#setLocation(int, int)
     * @since       1.1
     */
    public NPoint getLocation() {
     ...
     * @see         java.awt.Component#setLocation(java.util.NPoint)
     * @see         java.util.NPoint#getLocation
     * @since       1.1
     */
     ...
     * @see         java.util.NPoint#getLocation
     * @see         java.util.NPoint#move(int, int)
     * @since       1.1
     */
